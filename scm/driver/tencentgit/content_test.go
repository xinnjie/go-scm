...
func TestContentFind(t *testing.T) {
	...
	gock.New("https://git.code.tencent.com").
		Get("/api/v3/projects/xinnjie/testme/repository/files/app/models/key.rb").
...
func TestContentList(t *testing.T) {
	...
	gock.New("https://git.code.tencent.com").
		Get("/api/v3/projects/xinnjie/testme/repository/tree").
		MatchParam("ref", "7fd1a60b01f91b314f59955a4e4d4e80d8edf11d").
		Reply(200).
		Type("application/json").
		SetHeaders(mockHeaders).
...
func TestContentCreate(t *testing.T) {
	...
	gock.New("https://git.code.tencent.com").
		Post("api/v3/projects/octocat/hello-world/repository/commits").
		MatchType("json").
...
func TestContentUpdate(t *testing.T) {
	...
	gock.New("https://git.code.tencent.com").
		Put("api/v3/projects/octocat/hello-world/repository/files/README").
		MatchType("json").
