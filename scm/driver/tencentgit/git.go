...
func (s *gitService) FindRef(ctx context.Context, repo, ref string) (string, *scm.Response, error) {
	...
	path := fmt.Sprintf("api/v3/projects/%s/repository/commits?ref_name=%s", encode(repo), ref)
	out := []*commit{}
...
func (s *gitService) CreateRef(ctx context.Context, repo, ref, sha string) (*scm.Reference, *scm.Response, error) {
	params := url.Values{
		"branch_name": []string{ref},
		"ref":         []string{sha},
	}
	path := fmt.Sprintf("api/v3/projects/%s/repository/branches?%s", encode(repo), params.Encode())
...
func (s *gitService) FindBranch(ctx context.Context, repo, name string) (*scm.Reference, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/branches/%s", encode(repo), encode(name))
	out := new(branch)
	res, err := s.client.do(ctx, "GET", path, nil, out)
...
func (s *gitService) FindCommit(ctx context.Context, repo, ref string) (*scm.Commit, *scm.Response, error) {
	path := fmt.Sprintf("/api/v3/projects/%s/repository/commits/%s", encode(repo), encode(scm.TrimRef(ref)))
	out := new(commit)
	res, err := s.client.do(ctx, "GET", path, nil, out)
	return convertCommit(out, s.client.BaseURL, repo), res, err
}

func (s *gitService) FindTag(ctx context.Context, repo, name string) (*scm.Reference, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/tags/%s", encode(repo), encode(name))
	out := new(branch)
	res, err := s.client.do(ctx, "GET", path, nil, out)
...
func (s *gitService) ListBranches(ctx context.Context, repo string, opts scm.ListOptions) ([]*scm.Reference, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/branches?%s", encode(repo), encodeListOptions(opts))
	out := []*branch{}
	res, err := s.client.do(ctx, "GET", path, nil, &out)
...
func (s *gitService) ListCommits(ctx context.Context, repo string, opts scm.CommitListOptions) ([]*scm.Commit, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/commits?%s", encode(repo), encodeCommitListOptions(opts))
	out := []*commit{}
	res, err := s.client.do(ctx, "GET", path, nil, &out)
	return convertCommitList(out, s.client.BaseURL, repo), res, err
}

func (s *gitService) ListTags(ctx context.Context, repo string, opts scm.ListOptions) ([]*scm.Reference, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/tags?%s", encode(repo), encodeListOptions(opts))
	out := []*branch{}
	res, err := s.client.do(ctx, "GET", path, nil, &out)
...
func (s *gitService) ListChanges(ctx context.Context, repo, ref string, opts scm.ListOptions) ([]*scm.Change, *scm.Response, error) {
	path := fmt.Sprintf("api/v3/projects/%s/repository/commits/%s/diff", encode(repo), encode(ref))
	out := []*change{}
	res, err := s.client.do(ctx, "GET", path, nil, &out)
...
func (s *gitService) CompareCommits(ctx context.Context, repo, ref1, ref2 string, opts scm.ListOptions) ([]*scm.Change, *scm.Response, error) {
	...
	opts.To = encode(ref2)
	path := fmt.Sprintf("api/v3/projects/%s/repository/compare?%s", encode(repo), encodeListOptions(opts))
	out := compare{}
	res, err := s.client.do(ctx, "GET", path, nil, &out)
...
type commit struct {
	...
	AuthorDate     Time     `json:"authored_date"`
...
func convertCommitList(from []*commit, baseUrl *url.URL, repo string) []*scm.Commit {
	to := []*scm.Commit{}
	for _, v := range from {
		to = append(to, convertCommit(v, baseUrl, repo))
	}
	return to
}

func convertCommit(from *commit, baseUrl *url.URL, repo string) *scm.Commit {
	link := *baseUrl
	link.Path = path.Join(link.Path, repo, "commit", from.ID)
	return &scm.Commit{
